...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      text: "Tech Hub transformed my learning experience! The AI assistant helped me understand complex algorithms, and the coding platforms section guided me to the right practice problems. I've improved my problem-solving skills significantly.",
      avatar: "👨‍💻",
      rating: 5
    },
    {
      name: "Sarah Johnson",
      role: "B.Tech CSE, Year 4",
      text: "The placement preparation resources are incredible! I got detailed guidance for different companies, mock interview practice, and resume tips. The project ideas helped me build a strong portfolio that impressed recruiters.",
      avatar: "👩‍💻",
      rating: 5
    },
    {
      name: "Michael Rodriguez",
      role: "B.Tech CSE, Year 2",
      text: "As a second-year student, I was confused about what to learn next. Tech Hub's learning roadmaps and career guidance helped me plan my journey. The study materials are comprehensive and easy to understand.",
      avatar: "👨‍🎓",
      rating: 5
    },
    {
      ...
      text: "Starting my B.Tech journey was overwhelming, but Tech Hub made it so much easier! The year-wise materials, coding practice, and AI assistant provide everything I need to succeed in my academic journey.",
      avatar: "👩‍🎓",
      rating: 5
    }
  ];
  ...
  const stats = [
    { number: "1000+", label: "Study Resources", icon: "📚", color: "indigo" },
    { number: "50K+", label: "Students Helped", icon: "👥", color: "blue" },
    { number: "100+", label: "Companies Covered", icon: "🏢", color: "green" },
    { number: "98%", label: "Success Rate", icon: "🎯", color: "purple" }
  ];
